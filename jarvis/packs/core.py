...
Interrupting someone to confirm that Jarvis remembered their name would make the
...
from jarvis.memory.dna import ConfidenceCeilingError, DnaError
from jarvis.memory.recall import recall
...
from jarvis.tools.spec import SubagentSpec, ToolContext, ToolOutcome, ToolSpec
...
MEMORY_TOOLS: tuple[ToolSpec, ...] = (
    ToolSpec(
        ...
        description=(
            "Read the stable facts Jarvis holds about the person, plus a count of "
    ...
    ToolSpec(
        ...
        description=(
            "Search what Jarvis remembers about the person, ranked by relevance, "
