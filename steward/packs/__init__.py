...
from steward.packs.calendar import calendar_pack
from steward.packs.core import core_pack
from steward.packs.notes import notes_pack
...
def default_packs() -> tuple[CapabilityPack, ...]:
    ...
    Adding a pack here is the entire act of giving Steward a capability — and because
