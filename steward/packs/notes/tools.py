...
The append is the point. Notes are where thinking lives, so a steward that can add to
...
from steward.packs.notes.paths import (
    MAX_LIST,
    MAX_READ_BYTES,
    MAX_SEARCH_HITS,
    SUFFIX,
...
from steward.tools.spec import ToolContext, ToolOutcome
